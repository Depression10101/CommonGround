...
import { ArrowLeft, Clock, Package, DollarSign, MapPin } from 'lucide-react';
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-600">
                {transactions.length} {transactions.length === 1 ? 'transaction' : 'transactions'} awaiting completion
              </p>
            </div>
          </div>
          ...
          {transactions.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 text-lg mb-2">No pending transactions</p>
              <p className="text-gray-400 text-sm">
                When you initiate a purchase, it will appear here until completed or cancelled
              </p>
              <Button
                onClick={() => navigate('/')}
                ...
                return (
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                    <p className="text-xs text-gray-500">
                      Created {new Date(transaction.timestamp).toLocaleDateString('en-US', {
                        month: 'long',
                        day: 'numeric',
                        year: 'numeric',
                        hour: 'numeric',
